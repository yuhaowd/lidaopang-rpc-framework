...
public class RpcBeanPostProcessor implements BeanPostProcessor {
    ...
    private static String getString(Class<?> beanClass) {
        ...
        String interfaceName = aInterface.getSimpleName();
        // 获取实现类的全限定类名
    ...
    private static String getServiceName(Class<?> serviceClass, RpcReference rpcReference) {
        String interfaceName = serviceClass.getSimpleName();
        // 实现类名称
        ...
        return !implementationName.isEmpty() ? version + "/" + group + "/" + interfaceName + "/" + implementationName : version + "/" + group + "/" + interfaceName;
    }
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(RpcReference.class)) {
                ...
                String serviceName = getServiceName(serviceClass, rpcReference);
                Object proxy;
